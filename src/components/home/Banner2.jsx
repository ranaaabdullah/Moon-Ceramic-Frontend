...
const Banner2 = ({ title, desc, img, button = "shop now" }) => {
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 lg:40 ">
      <div className="flex flex-col justify-center  items-center h-80 text-center gap-8 bg-primary-200 px-24 py-14">
